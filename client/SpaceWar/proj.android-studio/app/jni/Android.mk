...
LOCAL_LDLIBS += -L$(LOCAL_PATH)/../../../cocos2d/external/curl/prebuilt/android/armeabi-v7a

LOCAL_LDLIBS += -lboost_atomic -lboost_chrono -lboost_date_time -lboost_regex -lboost_serialization -lboost_system -lboost_thread -lboost_wserialization -lcrypto -lssl
...
LOCAL_C_INCLUDES := $(LOCAL_PATH)/../../../Classes \
					$(LOCAL_PATH)/../../../../../sfs-api \
					$(LOCAL_PATH)/../../../../../external/boost/include \
					$(LOCAL_PATH)/../../../../../external/openssl/openssl-1.0.2/include
					
LOCAL_CPPFLAGS 	+= -DBOOST_THREAD_PROVIDES_FUTURE
